...
public class MaterialResourceService
{
    ...
    public MaterialResourceService(PostgresHelper pgHelper)
    {
        _pgHelper = pgHelper;
    }

    public bool InsertMaterialResource(string idVal, string productId, string productType,
        ...
        long createdAt, string createdBy, string station, long standingTime)
    {
        ...
        return _pgHelper.ExecuteNonQuery(insertSql, parameters);
    }
}
