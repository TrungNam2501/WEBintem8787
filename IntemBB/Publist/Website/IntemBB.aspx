...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 430px">
         <table  style="background-color:#D0ECE7;border:double">
             ...
             <tr class="trcls">
                 ...
                 <td>
                     <label class="cssLabel">&nbsp;&nbsp;Số mẻ sản xuất:&nbsp;&nbsp;</label>
                 </td>

                 <td>
                     <asp:TextBox ID="txtSoMeSX" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    
                 </td>
                 <td>
                      <label class="cssLabel">/</label>
                     <asp:TextBox ID="txtPlanNum" runat="server" Text="0" ReadOnly="true" style="width: 40px; border-block:revert; height:33px; font-size: 25px;font-weight: bold; font-family: Arial; color: black;"></asp:TextBox>
                 </td>
             ...
             <tr class="trcls">
                 ...
                 <td colspan="2">
                     <asp:DropDownList ID="drMayin" runat="server" CssClass="form-control1">
                       ...
                       <%--  <asp:ListItem>HP8EB81A (HP LaserJet Pro M404-M405)</asp:ListItem>--%>
                         
                     </asp:DropDownList>

                 </td>
                 <td>
                     <asp:Button ID="btnIntem" OnClientClick="showLoading();" OnClick="btnIntem_Click"  Style="font-weight: bold; font-size: 16px; font-family: Arial;width:150px;" CssClass="btn btn-success" runat="server" Text="InTem" />
                 </td>
              ...
              <tr class="trcls">
                 ...
                 <td>
                     ...
                     <%--<asp:TextBox ID="txtThoiGianKT" runat="server" ></asp:TextBox>--%>
                 </td>
             </tr>
