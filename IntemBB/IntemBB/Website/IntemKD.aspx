<%@ Page Title="" Language="C#" MasterPageFile="~/Website/menu.Master" AutoEventWireup="true" CodeBehind="IntemKD.aspx.cs" Inherits="IntemBB.Website.IntemKD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h1 style="font-family:Arial;font-weight:bold;color:#1B2631 ;font-size:50px">In tem quét KD</h1>
     <hr style="border: 1px solid #17202A;" />
</div>
 <div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 530px">
     <table  style="background-color:#e0e5d6;border:double">
          <tr class="trcls" >
              <td>
         ...
         <tr class="trcls">
             ...
             <td>
                 <label class="cssLabel">&nbsp;&nbsp;Số mẻ:&nbsp;&nbsp;</label>
             </td>

             <td colspan ="2">
                  <div style="display: flex; gap: 10px;"> <!-- 'gap' thêm khoảng cách giữa các textbox -->
                        <asp:TextBox ID="txtSoMeSX" runat="server" ReadOnly="true" CssClass="form-control" style="width: 100px;" ></asp:TextBox>
